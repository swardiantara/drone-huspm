...
class DroneLogAnalyzer:
    ...
    def analyze(self):
        ...
        os.makedirs(output_dir, exist_ok=True)
        self.report_generator.create_timeline_chart(records, self.abstractor.message_problem['binary'], output_dir)
        ...
        os.makedirs(output_dir, exist_ok=True)
        self.report_generator.create_timeline_chart(records, self.abstractor.sentence_problem['binary'], output_dir)
